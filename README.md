...
2. [Platform Refactor Roadmap](./sdd/ntn-sim-core-platform-refactor-roadmap.md)
3. [Implementation Status](./sdd/ntn-sim-core-implementation-status.md)
4. [Profile Baselines](./sdd/ntn-sim-core-profile-baselines.md)
5. [Development Constraints](./sdd/ntn-sim-core-development-constraints.md)
6. [Assumption Policy](./sdd/ntn-sim-core-assumption-policy.md)
...
- 目前 active program 已切換為 [Platform Refactor Roadmap](./sdd/ntn-sim-core-platform-refactor-roadmap.md)
- `validate:stage` 為 passing 狀態
- 已含 channel / handover / replay / beam hopping / energy L1/L2 / DAPS 主線

因此閱讀本專案時，應把它視為 **研究型模擬器主體**，但接下來的主要工作是把它重構成更長期可擴充的 simulator platform，而不是再沿著舊 closure 文件繼續堆疊功能。
