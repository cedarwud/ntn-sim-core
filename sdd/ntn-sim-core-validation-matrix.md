...
| VAL-RT-003 | E + structural | planned for T1 — dedicated real-trace truth-path parity validator over validation-sized cache sample ticks |
| VAL-RT-004 | structural | planned for T1 — dedicated wording/provenance/validator consistency check for shipped real-trace runtime truth |
...
| `VAL-RT-003` | T1 | ⏳ planned | — | Reserved for sampled-tick SGP4 parity over the validation-sized real-trace cache path |
| `VAL-RT-004` | T1 | ⏳ planned | — | Reserved for wording/provenance/validator consistency over the shipped real-trace runtime truth |
