...
| `VAL-PLAT-007` | P3 | ✅ PASS | 2026-03-31 | `scripts/validate-profiles.mjs` — authored registry parity confirmed for all 14 profiles via `materializeRuntimeProfile(entry.bundle, entry.exp)` deep-equality against `DEFAULT_PROFILES[entry.id]` |
