...
export const BEAM_AND_CHANNEL_PARAMETER_REGISTRY: ParameterEntry[] = [
  ...
  },
  {
    ...
    bindings: [
      ...
      { parameterId: 'PARAM-BEAM-INTERFERENCE-BEAMS', profileId: 'modqn-paper-baseline', defaultValue: 0, sourceTier: 'paper-backed', sourceId: 'PAP-2024-MORL-MULTIBEAM', sourceNote: 'paper Eq.(2) uses SNR without an interference term', exposureMode: 'Realistic' },
