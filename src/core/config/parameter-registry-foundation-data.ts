...
export const FOUNDATION_PARAMETER_REGISTRY: ParameterEntry[] = [
  {
    ...
    bindings: [
      ...
      { parameterId: 'PARAM-ORB-ALTITUDE-KM', profileId: 'real-trace-validation', defaultValue: 550, sourceTier: 'assumption-backed', sourceId: 'ASSUME-ORB-003', sourceNote: 'Starlink shell-1 nominal 550 km; real-trace ingest comes from external OMM/TLE records', exposureMode: 'Advanced' },
