  ...
  return (
    ...
    >
      ...
      <div
        ...
        data-serving-beam-id={runtime?.primaryUe?.servingBeamId ?? ''}
        data-target-sat-id={runtime?.primaryUe?.targetSatId ?? ''}
        data-target-beam-id={runtime?.primaryUe?.targetBeamId ?? ''}
        ...
        data-handover-count={runtime?.handoverCount ?? ''}
        data-bundle-handover-kind={runtime?.bundleHandoverKind ?? ''}
